                                ...
                                <div className="blog_left_sidebar">
                                    <article className="blog_item">
                                        <div className="blog_item_img">
                                            <img className="card-img rounded-0" src="Website/img/blog/single_blog_1.png" alt />
                                    ...
                                    <article className="blog_item">
                                        <div className="blog_item_img">
                                            <img className="card-img rounded-0" src="Website/img/blog/single_blog_2.png" alt />
                                            <a href="#" className="blog_item_date">
                                                <h3>15</h3>
                                                <p>Jan</p>
                                            </a>
                                    ...
                                    <article className="blog_item">
                                        <div className="blog_item_img">
                                            <img className="card-img rounded-0" src="Website/img/blog/single_blog_3.png" alt />
                                            <a href="#" className="blog_item_date">
                                                <h3>15</h3>
                                                <p>Jan</p>
                                            </a>
                                    ...
                                    <article className="blog_item">
                                        <div className="blog_item_img">
                                            <img className="card-img rounded-0" src="Website/img/blog/single_blog_4.png" alt />
                                            <a href="#" className="blog_item_date">
                                                <h3>15</h3>
                                                <p>Jan</p>
                                            </a>
                                    ...
                                    <article className="blog_item">
                                        <div className="blog_item_img">
                                            <img className="card-img rounded-0" src="Website/img/blog/single_blog_5.png" alt />
                                            <a href="#" className="blog_item_date">
                                                <h3>15</h3>
                                                <p>Jan</p>
                                            </a>
                                ...
                                <div className="blog_right_sidebar">
                                    ...
                                    <aside className="single_sidebar_widget popular_post_widget">
                                        ...
                                        <div className="media post_item">
                                            <img src="Website/img/post/post_1.png" alt="post" />
                                        ...
                                        <div className="media post_item">
                                            <img src="Website/img/post/post_2.png" alt="post" />
                                            <div className="media-body">
                                                <a href="blog_details.html">
                                        ...
                                        <div className="media post_item">
                                            <img src="Website/img/post/post_3.png" alt="post" />
                                            <div className="media-body">
                                                <a href="blog_details.html">
                                        ...
                                        <div className="media post_item">
                                            <img src="Website/img/post/post_4.png" alt="post" />
                                            <div className="media-body">
                                                <a href="blog_details.html">
                                    ...
                                    <aside className="single_sidebar_widget instagram_feeds">
                                        ...
                                        <ul className="instagram_row flex-wrap">
                                            <li>
                                                <a href="#">
                                                    <img className="img-fluid" src="Website/img/post/post_5.png" alt />
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#">
                                                    <img className="img-fluid" src="Website/img/post/post_6.png" alt />
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#">
                                                    <img className="img-fluid" src="Website/img/post/post_7.png" alt />
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#">
                                                    <img className="img-fluid" src="Website/img/post/post_8.png" alt />
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#">
                                                    <img className="img-fluid" src="Website/img/post/post_9.png" alt />
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#">
                                                    <img className="img-fluid" src="Website/img/post/post_10.png" alt />
                                                </a>
                                            </li>
                                        </ul>
                                    </aside>
