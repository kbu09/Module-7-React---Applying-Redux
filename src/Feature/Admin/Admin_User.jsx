                                    ...
                                    <div className="col-xl-4">
                                        <div className="card">
                                            <div className="card-body profile-card pt-4 d-flex flex-column align-items-center">
                                                <img src={value.image}alt="Profile" className="rounded-circle" />
                                                <h2>{value.name}</h2>
                                                <h3>Web Designer</h3>
                                        ...
                                        <div className="card">
                                            <div className="card-body pt-3">
                                                ...
                                                <ul className="nav nav-tabs nav-tabs-bordered">
                                                    ...
                                                    <NavLink className="nav-item" to={'/edituser/' + value.id}>
                                                ...
                                                <div className="tab-content pt-2">
                                                    <div className="tab-pane fade show active profile-overview" id="profile-overview">
                                                        ...
                                                        <div className="row">
                                                            ...
                                                            <div className="col-lg-9 col-md-8">{value.name}</div>
                                                        </div>
                                                        <div className="row">
                                                            <div className="col-lg-3 col-md-4 label">Number</div>
                                                            <div className="col-lg-9 col-md-8">{value.number}</div>
                                                        </div>
                                                        <div className="row">
                                                            <div className="col-lg-3 col-md-4 label">Email</div>
                                                            <div className="col-lg-9 col-md-8">{value.email}</div>
                                                        </div>
                                                        <div className="row">
